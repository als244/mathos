...
Self_Port *** init_port_container(Self_Net * self_net, int num_qp_types, QueuePairUsageType * qp_usage_types, bool * to_use_srq_by_type, int * num_qps_per_type) {
...
Self_Net * default_config_init_self_net(int self_id) {
	...
	return init_self_net(self_id, num_qp_types, qp_usage_types, to_use_srq_by_type, num_qps_per_type, num_cq_types, cq_usage_types);
}
