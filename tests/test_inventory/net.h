...
struct ibv_ah * get_dest_ah_from_request(World_Net * net_world, uint32_t dest_node_id, uint8_t dest_device_id, uint8_t dest_port_num);

Net_Endpoint * get_ctrl_endpoint(World_Net * net_world, uint32_t dest_node_id);
