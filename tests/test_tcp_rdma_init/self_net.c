...
Self_Net * init_self_net(int num_endpoint_types, EndpointType * endpoint_types, bool * to_use_srq_by_type, int * num_qps_per_type, char * ip_addr){
...
Self_Net * default_worker_config_init_self_net(char * ip_addr) {
	...
	return init_self_net(num_endpoint_types, endpoint_types, to_use_srq_by_type, num_qps_per_type, ip_addr);
}
